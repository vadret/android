...
class WeatherForecastTinyAppWidgetProvider : BaseAppWidgetProvider() {
    ...
    @Inject
    lateinit var viewModel: WeatherForecastTinyViewModel

    @Inject
    lateinit var subscriptions: CompositeDisposable

    @Inject
    lateinit var onWidgetInitialisedSubject: PublishSubject<WeatherForecastTinyView.Event.OnWidgetInitialised>

    @Inject
    lateinit var onWidgetUpdatedSubject: PublishSubject<WeatherForecastTinyView.Event.OnWidgetUpdated>

    @Inject
    lateinit var onBootCompletedSubject: PublishSubject<WeatherForecastTinyView.Event.OnBootCompleted>

    @Inject
    lateinit var context: Context

    @Inject
    lateinit var cmp: WeatherForecastTinyComponent
