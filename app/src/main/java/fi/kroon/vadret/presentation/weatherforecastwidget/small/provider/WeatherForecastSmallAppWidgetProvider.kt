...
class WeatherForecastSmallAppWidgetProvider : BaseAppWidgetProvider() {
    ...
    private val onWidgetInitialisedSubject: PublishSubject<WeatherForecastSmallView.Event.OnWidgetInitialised> by lazy(LazyThreadSafetyMode.NONE) {
        cmp.provideOnWidgetInitialised()
    }

    private val onWidgetUpdatedSubject: PublishSubject<WeatherForecastSmallView.Event.OnWidgetUpdated> by lazy(LazyThreadSafetyMode.NONE) {
        cmp.provideOnWidgetUpdated()
    }

    private val onBootCompletedSubject: PublishSubject<WeatherForecastSmallView.Event.OnBootCompleted> by lazy(LazyThreadSafetyMode.NONE) {
